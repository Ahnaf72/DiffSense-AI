...
def get_embeddings(texts: list[str]) -> Optional[np.ndarray]:
    ...
    """
    from backend.nlp_utils import get_embeddings as _get_embs
...
from backend.nlp_utils import remove_references
